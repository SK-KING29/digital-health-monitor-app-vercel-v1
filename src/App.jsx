...
{ sender: "ai", text: "Hi 👋 I'm your AI Health Assistant powered by Claude! Ask me anything about burnout, sleep, screen time, or wellness habits!" }
]);
...
try {
  ...
  const contextInfo = `User's current health data:
- Screen time: ${screen} hours/day
- Sleep: ${sleep} hours/night
- Work/study: ${work} hours/day
- Stress level: ${stress}/5 (${['', 'Minimal', 'Low', 'Moderate', 'High', 'Severe'][stress]})
- Mood: ${mood}/5 (${['', 'Poor', 'Fair', 'Good', 'Very Good', 'Excellent'][mood]})
- Burnout score: ${burnout}%
- Healthy habits followed: ${habitsCount}/8
- Habits: ${Object.entries(habits).filter(([_, v]) => v).map(([k]) => k).join(', ') || 'none'}`;

  const systemPrompt = `You are a compassionate AI health assistant specializing in digital wellness and burnout prevention. 
Your role is to provide helpful, evidence-based advice about screen time, sleep, stress management, and healthy habits.
Be supportive, concise (2-3 sentences max), and actionable. Use relevant emojis occasionally.
  ...
  <>
    ...
    <div className="glass" style={{ marginTop: "32px" }}>
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        <input
          ...
          placeholder="Ask Claude about burnout, sleep, screen time..."
          style={{
            flex: 1,
            padding: "12px 16px",
            borderRadius: "10px",
      ...
      <div style={{
        ...
        💡 Try asking: "How can I reduce my screen time?" or "What's causing my high burnout score?"
      </div>
    </div>
    ...
    <div className="glass" style={{ marginTop: "32px" }}>
      ...
      <p style={{ textAlign: "center", opacity: 0.85, marginBottom: "20px" }}>
        This simulation shows the possible health impact if your current habits continue for the next 30 days.
      </p>
